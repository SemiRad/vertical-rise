...
<head>
  ...
  <nav class="navbar navbar-expand-lg fixed-top bg-light navbar-light">
    <div class="container">
      <a class="navbar-brand" href="/home">VERTICAL RISE</a>
      <button
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto align-items-center">
          ...
          <li class="nav-item ms-3">
            <a class="btn btn-black btn-rounded" href="/account">Account</a>
          </li>
  ...
  <body>
    ...
    <tr>
        ...
        <td class="text-center">{{ $shirt->shirt_name }}</td>
        ...
        <td class="text-center">{{ $userId->address }}</td>  
        <td class="text-center">{{ $userId->contact }}</td>  
        ...
        @if($order->order_status !== 'CANCELLED' && $order->order_status !== 'FULFILLED')
                <form method="get" id="delForm" action="{{ route('cancelOrder', [$order->id, $shirtId]) }}">
                    <button class="btn btn-danger" onclick="showModal($order->id)">Cancel</button>
                    <!-- MODAL -->
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <div class="modal-button-container">
                                <input type="submit" value="YES" form="delForm">
                                <input type="button" value="NO" style="background-color: rgba(0, 0, 0, 0.4);" onclick="hideModal()">
                            </div>
                        </div>
                    </div>
                </form>
